...
\item "Design and Validation of a Multi-Arm Relocatable Manipulator for Space Applications" (under review).
\end{itemize}
\end{itemize}
\end{itemize}
}
...
\cvitem{\listitemsymbol}{"\textbf{wolf-controller} - Whole-body Locomotion Framework for quadruped robots" 
...
\newline
\emph{Under review for the IEEE International Conference on Robotics and Automation (ICRA).}}
...
%\href{https://arxiv.org/pdf/2205.06526.pdf}{\faFile \underline {}} 
\newline
\emph{Under review for the Conference on Human-Robot Interaction (HRI).}}
