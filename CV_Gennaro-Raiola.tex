...
\email{gennaro.raiola@ensta-paristech.fr}
\homepage{perso.ensta-paristech.fr/\textasciitilde raiola/}%{web} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
...
%----------------------------------------------------------------------------------------
\section{Education}
\cvitem{2013-current}{\emph{Ph.D. student in Robotics} \newline{} at ENSTA-ParisTech.}
...
\cvitem{2012-2013}{\emph{Research Engineer in Motion Control of Humanoid Robots} \newline{} 
		at PAL Robotics S.L. Barcelona \href{http://www.pal-robotics.com}\Mundus \underline {www}} %%{{\Mundus \underline {www}}}}
...
\cvitem{Ph.D. Thesis}{"Probabilistic virtual guides for co-manipulation" \newline{}
	...
	\underline{Topics}: Virtual Fixtures, Industrial Applications, Control, Machine Learning.}}
...
\cvitem{M.Sc. Thesis}{"Learning Parameterized Skills through Models with Expanded Kernels" \newline{} 
	...
	\underline{Topics}: Motion Primitives, Control, Machine Learning.}}

%\cvitem{Software}{"m3ros_control" \href{https://github.com/graiola/m3ros_control}{ \Mundus \underline {github}} \newline{}
%	\footnotesize{C++ bridge to integrate the control layer of the Meka robot into a ROS environment.}}

\cvitem{Software}{"m3ros-control" \href{https://github.com/graiola/m3ros_control}{ \Mundus \underline {github}} \newline{}
	\footnotesize{C++ bridge to integrate the control layer of the Meka robot into a ROS environment.}}

\cvitem{Software}{"DmpBbo" \href{https://github.com/stulp/dmpbbo}{ \Mundus \underline {github}} \newline{}
	\footnotesize{C++ framework for motion primitives and black-box optimization.}}

\cvitem{Software}{"Stack-of-Task" \href{https://github.com/stack-of-tasks}{ \Mundus \underline {github}} \newline{}
...
"Compact Parameterized Skills with a Single Regression". \newline{}
