...
\cventry{04/2021--current \logo{leonardo}}{Research fellow}{Leonardo s.p.a.  \href{https://www.leonardocompany.com/}{\Mundus}}{Genoa}{Italy}{ 
...
\begin{itemize}
\item Given my experience and seniority, I coordinate and lead the daily activities of the laboratory, which include:
\begin{itemize}
\item supervising the research activities of my group,
%\item supervising the tasks necessary to setup and start the laboratory,
\item working on european project proposals,
\item definition of the activities and the necessary hardware to develop and build a new quadruped robotic platform for navigation and exploration of unstructured enviroments.
\end{itemize}
\item Technical work:
\begin{itemize}
