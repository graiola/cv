...
\cvitem{2014-2016}{\emph{Ph.D. student in Robotics} @ INRIA-Flowers and ENSTA-ParisTech, Palaiseau, France. \Mundus \href{https://flowers.inria.fr/}{ \underline{www}}.}
...
\cvitem{\listitemsymbol}{Deep knowledge of Linux-based operating systems (Ubuntu, Red Hat, Fedora, Debian).}
\cvitem{\listitemsymbol}{Experienced with real time operating systems (RTAI Linux, Xenomai Linux, RT-PREEMPT), Kernel configuration, hacking.}
...
\href{https://www.researchgate.net/publication/322610900_Development_of_a_Safety_and_Energy_Aware_Impedance_Controller_for_Collaborative_Robots}{\faFile \underline {}} 
\newline
