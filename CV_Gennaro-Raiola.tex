...
\address{Wooldriksweg 134}{7512 BE Enschede, NL}
...
%----------------------------------------------------------------------------------------
\section{Education}
\cvitem{2017-current}{\emph{Post-Doc} \newline{} at Robotics and Mechatronics group, University of Twente  \newline \Mundus \href{https://www.ram.ewi.utwente.nl/}{ \underline{www}}.}
...
\cvitem{2014-2015}{\emph{Ph.D. student in Robotics} \newline{} at INRIA - Flowers / ENSTA-ParisTech \Mundus \href{http://cogrob.ensta-paristech.fr/}{ \underline{www}}.}
...
\cvitem{Post-doc}{Energy based control strategies for prosthetics \newline{}
	\footnotesize{\underline{Supervisors}: Prof. Stefano Stramigioli. \newline{}
	\underline{Topics}: Controls, Passivity.}}
...
\cvitem{Programming}{C/C++, Python, MATLAB, ROS, Orocos, Qt, Boost, RTAI/Xenomai, Eigen, php (Basics)}
\cvitem{Systems/Tools}{Linux/Ubuntu, CMake, Latex, QtCreator, Gazebo, Eclipse, git, svn, VirtualBox, Docker (Basics), EtherCAT (Basics)}
\cvitem{Hardware}{Arduino}

\subsection{Software projects}

\cvitem{Software}{"ros-control" 
...
\href{http://www.isybot.com/images/Products/20161026_comanipulation_library_guides.mp4}{\faPlayCircle \underline{}} 
...
\cvitem{2017}{Gennaro Raiola, Susana Sanchez Restrepo, Pauline Chevalier, et al. \newline{}
...
\newline
Under Review for \emph{Autonomous Robots, Special Issue on Learning for Human-Robot Collaboration.}}
...
%\href{https://hal-cea.archives-ouvertes.fr/hal-01170974/document}{\faFile \underline {}} 
\newline
Under Review for \emph{IEEE International Conference on Advanced Intelligent Mechatronics (AIM).}}
...
\cvitem{Open-source}{Maintainer of ros-control packages.}
