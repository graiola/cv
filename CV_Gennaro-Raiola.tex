...
\item created a state estimation algorithm to track and pick boxes of various shapes with robotic manipulators (internal project with Leonardo automation division),
\item working on locomotion algorithms for quadruped robots based on whole-body and model predictive control techinques,
...
\item setup of the robot software and pilot stations,
...
\item "Design and Validation of a Multi-Arm Relocatable Manipulator for Space Applications" (accepted).
\item "Artifacts Mapping: Multi-Modal Semantic Mapping Extension of Geometric Maps" (under review).
\end{itemize}
\end{itemize}
\end{itemize}
}
