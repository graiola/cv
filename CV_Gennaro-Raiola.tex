...
Robotics, programming, navigation and locomotion, inverse kinematics and dynamics, embedded, DevOps, ROS.
\section{Profession}
%\cventry{04/2021--current}{R&D robotics engineer}{Leonardo s.p.a }{Genoa}{Italy}{ }
\cventry{04/2021--current \logo{leonardo}}{Senior researcher in navigation and locomotion}{Leonardo s.p.a.  \href{https://www.leonardocompany.com/}{\Mundus}}{Genoa}{Italy}{ 
In Leonardo I work in the joint robotic laboratory with the Italian Institute of Technology (IIT) on the development of software algorithms for autonomous navigation and locomotion of unmanned ground vehicles (UGVs) in unstructured environments \href{https://www.youtube.com/watch?v=he9AoLA0YGA&list=PLF-yhjaPBSInADZXA08dGjzwVSredTlwh}{\faPlayCircle}.
\begin{itemize}
\item Given my experience and seniority, I coordinate and lead the daily activities of the group, which include:
\begin{itemize}
\item supervising the research activities of junior research fellows,
\item working on european project proposals,
\item definition of the activities and the necessary hardware and software to develop and build a new quadruped robotic platform for navigation and exploration of unstructured enviroments.
\end{itemize}
\item Technical work:
\begin{itemize}
\item developed navigation, exploration and detection algorithms for mobile robots,
\item working on locomotion algorithms for quadruped robots based on whole-body and model predictive control techniques,
\item created the kinematics and dynamics model for the ESA robot Mirror in collaboration with IIT,
\item created a state estimation for control and odometry of quadruped robotic platforms,
\item created virtual enviroments with Docker to ease the deployment of AI and vision software on the robots,
\item DevOps such as setup of the git repository, internal Docker registry, etc...,
\item setup of the robot software, pilot stations and network capabilities with LTE and 5G technologies,
...
\item "Target-Referred DMPs for Learning Bimanual Tasks from Shared-Autonomy Telemanipulation" (accepted).
\item "FollowMe: a Robust Person Following Framework Based on Visual Re-Identification and Gestures" (accepted).
\item "Design and Validation of a Multi-Arm Relocatable Manipulator for Space Applications" (accepted).
\item "Artifacts Mapping: Multi-Modal Semantic Mapping Extension of Geometric Maps" (accepted).
\end{itemize}
\end{itemize}
\end{itemize}
}
...
\cvitem{\listitemsymbol}{Competent with \textbf{Qt}, \textbf{Eigen} and \textbf{ROS} and \textbf{ROS2}}
